...
import AirFiltrationInstallationDetail from './AirFiltrationInstallationDetail';
...
const AirFiltrationInstallation= () => {
  return (
    <>
      <Introduction imgSrc="/img/aircon/air-filtration/banner" />
       <AirFiltrationInstallationDetail />
      <Disclaimer />
