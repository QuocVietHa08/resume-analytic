...
const Home = () => {
  ...
  // const [isStopGenerate, setIsStopGenerate] = React.useState(false);
  ...
  // useEffect(() => {
  //   if (isStopGenerate && !loading) {
  //     setTimeout(() => {
  //       setIsStopGenerate(false);
  //     }, 500)
  //   }
  // }, [isStopGenerate, loading])
  ...
  //   setIsStopGenerate(true);
  //   setLoading(false);
  // }
  // const openModalContentChatbot = () => {};
