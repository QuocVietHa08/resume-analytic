...
import InsecticideSprayingDetail from './InsecticideSprayingDetail';
...
const InsecticideSpraying = () => {
  return (
    <div className={styles.shrubPlantsContainer}>
      <Introduction imgSrc="/img/landscaping/insecticide-spraing/banner" />
      <InsecticideSprayingDetail />
      <Disclaimer />
